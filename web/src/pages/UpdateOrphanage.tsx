...
export default function UpdateOrphanage() {
  ...
  const handleDeleteImage = useCallback((position: number) => {
  ...
  const handleDeleteImageExist = useCallback((id: number) => {
  ...
  }, [about, history, images, imagesDeleted, instructions, name, open_on_weekends, opening_hours, params.id, position]);
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <div className="images-container">
                {previewImages.map((image, index) => (
                  <div className="image" key={image}>
                    <FiX color="#FF669D" onClick={() => handleDeleteImage(index)} />
                ...
                {imagesExists.map((image, index) => (
                  <div className="image" key={image.id}>
                    <FiX color="#FF669D" onClick={() => handleDeleteImageExist(image.id)} />
              ...
              <input type="file" multiple id="image[]" onChange={handleSelectImage}/>
            </div>
          </fieldset>
